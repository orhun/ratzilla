...
fn render_horizontal_barchart(area: Rect, buf: &mut Buffer) {
    ...
    let data = [
        Bar::default()
            .text_value("Winter 37-51".to_string())
            .value(51),
        Bar::default()
            .text_value("Spring 40-65".to_string())
            .value(65),
        Bar::default()
            .text_value("Summer 54-77".to_string())
            .value(77),
        Bar::default()
            .text_value("Fall 41-71".to_string())
            .value(71)
